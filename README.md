# Filo ϕ — Sample Markdown Files

Sample `.md` files for [Filo ϕ](https://terramar.dev/products/filo/), a Markdown reader for macOS. These files are provided for App Review and cover the full range of features supported by the app.
...
Each file can be downloaded directly from GitHub using the **Raw** button on any file page, or cloned in full:

```
git clone https://github.com/brunellus-terramar/filo-markdown-files.git
```
